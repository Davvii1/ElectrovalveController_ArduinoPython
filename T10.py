...
try:
    ...
    messagebox.showerror('Error', 'Error: Connect Arduino Uno board and execute again!')
...
try:
    ...
    urllib.request.urlretrieve("https://thumbs.dreamstime.com/b/no-image-available-icon-flat-vector-no-image"
                               "-available-icon-flat-vector-illustration-132482953.jpg", "nia.jpg")
    img = (Image.open("nia.jpg"))
